...
${JAVA_PATH}/java -Xms512M -Xmx1024M -jar ${JAVA_JAR_PATH}/${BATCH_JAR_FILE} ${BATCH_ID} ${INTERFACE_PATH} ${WORKING_PATH} ${BACKUP_PATH} 2>&1 >> $BATCH_ERROR_LOG_DIR/$ERROR_FILE
ret=$?
