...
${JAVA_PATH}/java -Xms512M -Xmx1024M -Dpoi.keep.tmp.files=false -jar ${JAVA_JAR_PATH}/${BATCH_JAR_FILE} ${BATCH_ID} ${BATCH_DATE} ${OFFICE_CODE} ${SUB_PROCESS} 2>&1 >> $BATCH_ERROR_LOG_DIR/$ERROR_FILE
ret=$?
