...
${JAVA_PATH}/java -Xms512M -Xmx1024M -Dpoi.keep.tmp.files=false -jar ${JAVA_JAR_PATH}/${BATCH_JAR_FILE} ${BATCH_ID} ${BUSINESS_PATTERN} ${OFFICE_CODE} ${BATCH_DATE} $5 2>&1 >> $BATCH_ERROR_LOG_DIR/$ERROR_FILE
ret=$?
