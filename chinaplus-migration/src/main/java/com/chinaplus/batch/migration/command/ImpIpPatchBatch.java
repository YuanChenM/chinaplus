...
import com.chinaplus.batch.migration.service.ImpIpPatchService;
 ...
 * @author yang_jia1
 */
@Component("ImpIpPatch")
public class ImpIpPatchBatch extends BaseBatch {

    /** logger */
    private static Logger logger = LoggerFactory.getLogger(ImpIpPatchBatch.class);

    @Autowired
    private ImpIpPatchService ipPatchService;
    ...
    public boolean doOperate(BaseBatchParam param) throws Exception {
        ...
        // do test
        ipPatchService.doImpIpPatchSync(castparam.getOfficeCode());
