...
/**
 * Revised Shipping Status Doc1 Download Service.
 */
@Service
public class CPSSMF01Service extends BaseService {

    /**
     * get TntSsMaster by ssId
     * 
     * @param param BaseParam
     * @return TntSsMaster entity
     */
    public TntSsMaster getSsMaster(BaseParam param) {
        return this.baseMapper.findOne(this.getSqlId("getSsMaster"), param);
    }
     ...
     */
    public List<CPSSMF01Entity> searchPartsInfo(BaseParam param, List<TntOrder> orderList,
        List<TntOrder> orderListByInvoice) {
        ...
        List<CPSSMF01Entity> dataList = this.baseMapper.select(this.getSqlId("searchPartsInfo"), param);
    ...
    public void sortPlanAndActualInfo(List<CPSSMF01Entity> planList, List<CPSSMF01Entity> invoiceList,
        ...
        if (null != planAndActualColList && !planAndActualColList.isEmpty()) {
            ...
            for (CPSSMF01ColEntity item : planAndActualColList) {
                ...
                if (null != etd && officeTime.after(etd)) {
